...
export class AddMasterNumberComponent implements OnInit {
  ...
  showDialog1(companyType){
    ...
    if(companyType=="Insurance Company"){
      this.companyLabel=this.companyType;
    }
    else{
     ...
     if (this.masterName !== undefined && this.masterName.length>0)
      ...
      if(this.customerBasicInfo.customerId === undefined)
        ...
        /* Start of Billing Address */
         ...
         if (this.isBillingAddressSame!== undefined) this.masterNumberData.billingAddressSame=this.isBillingAddressSame;
             else   this.masterNumberData.billingAddressSame=false;   
