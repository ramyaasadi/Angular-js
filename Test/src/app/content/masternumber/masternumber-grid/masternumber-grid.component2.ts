...
export class MasterNumberGridComponent implements OnInit,AfterViewInit {
  ...
  dtElement: DataTableDirective;
    ...
    jobTypes:string[]=['Water','Reconstruction','Content','Mold','Asbestos','Board','Consulting','Bio'];
                     ...
                     let foundPosition=0;
                      ...
                      for (let j=0;j<this.jobTypes.length;j++){
                          ...
                          if (found){
                             ...
                             this.singleJob.jobImage=this.jobImagepath+this.jobTypes[j]+"_r.png";
                            ...
                            //console.log('True :'+this.singleJob.isjobActive);
                             ...
                             this.singleJob.jobImage=this.jobImagepath+this.jobTypes[j]+"_.png";
                            this.singleJob.jobType=this.jobTypes[j];
